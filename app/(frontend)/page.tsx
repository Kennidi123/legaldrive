  ...
  return (
    <>
      ...
      <div className="max-w-content mx-auto px-4 md:px-16 py-16">
        ...
        {/* ============ ALERTA CTB ============ */}
        <section className="mb-16 bg-[var(--tertiary-container)] border border-[var(--on-primary-fixed-variant)] rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
                    ...
                    <article className="flex flex-col md:flex-row gap-6 group">
                      ...
                      <div className="md:w-2/3">
                        ...
                        <div className="mt-4 flex items-center text-[var(--primary-fixed-dim)] font-mono text-[11px] gap-4">
                          <span className="flex items-center gap-1"><Icon d={P.clock} className="w-4 h-4" /> {i === 0 ? '2 horas atrás' : '5 horas atrás'}</span>
                          <span className="flex items-center gap-1"><Icon d={P.comment} className="w-4 h-4" /> {i === 0 ? '14 comentários' : '8 comentários'}</span>
                        </div>
                      </div>
                    </article>
          ...
          <aside className="lg:col-span-4 space-y-16">
            ...
            {/* Canal WhatsApp */}
            <Link href={whatsapp} target="_blank" rel="noopener noreferrer" className="block bg-[var(--secondary-container)] p-8 rounded-xl hover:brightness-105 transition-all group">
              <div className="flex items-center gap-4">
                <div className="bg-[var(--tertiary-container)] p-3 rounded-full text-[var(--on-secondary-container)]"><Icon d={P.chat} /></div>
                <div>
                  <h3 className="font-mono text-sm text-[var(--on-secondary-container)] font-bold">Canal Legal Drive</h3>
                  <p className="text-[var(--on-secondary-container)]/80 font-mono text-[11px]">Receba atualizações jurídicas no WhatsApp</p>
                </div>
              </div>
              <div className="mt-4 flex justify-end">
                <span className="bg-[var(--tertiary-container)] text-[var(--on-secondary-container)] px-4 py-2 rounded-lg font-mono text-[11px] group-hover:scale-105 transition-transform inline-block">ENTRAR NO CANAL</span>
              </div>
            </Link>

            {/* Banner Premium */}
            <div className="relative overflow-hidden rounded-xl p-8 min-h-[300px] flex flex-col justify-end group border border-[var(--on-primary-fixed-variant)] bg-[var(--primary-container)]">
              <Image src={IMG.premium} alt="" fill sizes="(max-width:1024px) 100vw, 33vw" className="object-cover opacity-30 group-hover:scale-110 transition-transform duration-1000" />
              <div className="relative z-10">
                <span className="text-[var(--secondary)] font-mono text-[11px] uppercase mb-2 block">Premium</span>
                <h3 className="font-display text-2xl font-bold mb-4">Monitoramento Inteligente CNH</h3>
                <p className="text-[var(--primary)] text-base mb-6">Monitore pontos, prazos e multas em tempo real com nossa inteligência jurídica integrada.</p>
                <Link href="/contato" className="block w-full text-center bg-[var(--secondary)] text-[var(--on-secondary)] py-3 font-mono text-sm rounded-xl hover:brightness-110 transition-colors">Conhecer Plataforma</Link>
              </div>
            </div>
